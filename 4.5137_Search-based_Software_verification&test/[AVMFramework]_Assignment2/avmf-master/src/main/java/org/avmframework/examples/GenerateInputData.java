...
public class GenerateInputData {
  ...
  //       (e.g., "HillClimbingSearch", "IteratedPatternSearch", "GeometricSearch" or "LatticeSearch")
  ...
  static final int MAX_EVALUATIONS = 10000000;

  public static void main(String[] args) {
    // Nested class to help parse command line arguments(defined in this file)
