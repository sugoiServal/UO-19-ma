...
def FeatureEng(data): 
    ...
    #df = pd.read_excel(r'C:\Users\funrr\Desktop\ML project\temp\rare.xlsx', header= None)
    a = [13., 14., 15., 16., 17., 18., 19., 20., 41., 42.]
    b = [ 10.,  11.,  12.,  21.,  22.,  23.,  24.,  29.,  30.,  31.,  32.,
        33.,  34.,  43.,  44.,  45.,  46.,  47.,  48.,  49.,  58.,  59.,
        60.,  61.,  62.,  69.,  70.,  71.,  84.,  85.,  92.,  93.,  94.,
        96.,  97.,  98.,  99., 120., 121., 127.]
    c = [  1,   2,   3,   4,   5,   6,   7,   8,   9,  25,  26,  27,  28,
        35,  36,  37,  38,  39,  40,  50,  51,  52,  53,  54,  55,  56,
        57,  63,  64,  65,  66,  67,  68,  72,  73,  74,  75,  76,  77,
        78,  79,  80,  81,  82,  86,  87,  90,  91,  95, 100, 101, 102,
       103, 104, 105, 109, 110, 111, 112, 114, 116, 117, 118, 119, 123,
       124, 125, 126, 128, 133, 134, 135, 136, 138, 139, 140, 141, 143,
       147, 148, 149]
    d = [ 88.,  89., 106., 107., 108., 113., 129., 130., 137., 142.]
    e = [ 83., 132., 144., 145., 146., 150., 151., 115., 122., 131.]
